...
final class CameraConfigurationManager {
	...
	void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		if (CameraConfiguration.getBoolean(CameraConfiguration.KEY_AUTO_FOCUS,
				true)) {
			if (safeMode
					|| CameraConfiguration.getBoolean(
							CameraConfiguration.KEY_DISABLE_CONTINUOUS_FOCUS,
							false)) {
		...
		if (CameraConfiguration.getBoolean(CameraConfiguration.KEY_INVERT_SCAN,
				false)) {

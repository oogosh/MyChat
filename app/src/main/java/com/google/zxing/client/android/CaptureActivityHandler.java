...
public class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		if (message.what == DecodeHandler.RESTART_PREVIEW) {
			Log.d(TAG, "Got restart preview message");
			restartPreviewAndDecode();

		} else if (message.what == DecodeHandler.DECODE_SUCCEEDED) {
		...
		} else if (message.what == DecodeHandler.DECODE_FAILED) {
		...
		} else if (message.what == DecodeHandler.RETURN_SCAN_RESULT) {
			Log.d(TAG, "Got return scan result message");
			activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
			activity.finish();

		} else if (message.what == DecodeHandler.LAUNCH_PRODUCT_QUERY) {
